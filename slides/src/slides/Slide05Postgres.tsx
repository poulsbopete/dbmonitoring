      ...
      <div className="flex flex-col h-full px-10 py-8 gap-4 overflow-hidden">
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
          <div className="flex items-center gap-3 mb-1">
            ...
            <span className="text-white/80 text-[10px] border border-white/10 rounded-full px-2 py-0.5">TSDB · high-cardinality metrics · live data</span>
          </div>
          <h2 className="text-4xl font-bold text-white leading-tight">
            Connection & Health <span className="text-white/70">At a Glance</span>
          </h2>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.9 }}
          ...
          Stream: <code className="text-white/70">metrics-postgresqlreceiver.otel.otel-default</code>
        </motion.div>
      </div>
    </SlideLayout>
  );
